...
public class DataForTest {
    ...
    DotDangKyHocPhan d1=new DotDangKyHocPhan("1", null, null);
    PhieuDangKyHocPhan p1 =new PhieuDangKyHocPhan(ntphuoc, d1);
    PhieuDangKyHocPhan p2 =new PhieuDangKyHocPhan(ntphuc, d1);
    public DataForTest(){
...
//        ctdl1.addMonTienQuyet(ltrA2);
        ...
        ntphuoc.getBangDiem().themDiem(new Diem(ltrA1, 3.));
        ntphuoc.getBangDiem().themDiem(new Diem(ktctri, 6.));
        ntphuoc.getBangDiem().themDiem(new Diem(mmt, 7.));

        ntphuc.getBangDiem().themDiem(new Diem(ltrA1, 3.));
